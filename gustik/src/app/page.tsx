export default function HomePage() {
  return (
    <main className="mx-auto max-w-5xl px-6 py-12">
      <section>
        <h1 className="text-4xl font-bold">Servis notebooků</h1>
      ...
      <section className="mt-12 rounded-2xl border p-6">
        ...
        <div className="space-y-1 text-slate-600">
          ...
          <div>✔ Doprava zpět zdarma při realizaci opravy</div>
          <div>✔ Opravu provádíme až po vašem schválení ceny</div>
          <div>✔ Servis notebooků s více než 10letou tradicí</div>
        </div>
      </section>
      ...
      <section className="mt-12 rounded-2xl border p-6">
        ...
        <div className="space-y-1 text-slate-600">
          ...
          <div>Oprava napájecího konektoru včetně USB‑C: 2 500–3 000 Kč</div>
        </div>
      </section>
