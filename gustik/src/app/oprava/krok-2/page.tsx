      ...
      <div className="mt-8 grid gap-4 sm:grid-cols-2">
        <Link className="rounded-xl border p-6 hover:bg-slate-50" href="/oprava/cena">
          ...
          <div className="mt-2 text-sm text-slate-600">
            Vyplníte krátký formulář včetně SN. PN / model je volitelný.
          </div>
        </Link>
        ...
        <Link className="rounded-xl border p-6 hover:bg-slate-50" href="/oprava/formular">
          ...
          <div className="mt-2 text-sm text-slate-600">
            Vyplníte formulář a obdržíte instrukce k zaslání zařízení. Platba probíhá až po schválení ceny opravy.
          </div>
        </Link>
      </div>
